            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>addedNewRoom" method="POST" enctype="multipart/form-data" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="no_of_adults" name="no_of_adults" maxlength="2">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="mobile">Number of Childs</label>
                                        <input type="number" class="form-control" id="no_of_childs" name="no_of_childs" maxlength="2">
                                    </div>
                                </div>    
                            </div>
                        </div><!-- /.box-body -->
