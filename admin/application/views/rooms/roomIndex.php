                      ...
                      <td><div class="row" style="display: flex;flex-wrap: wrap;">
                        <?php 
                          ...
                          for($i=0;$i<count($imgarr);$i++){
                            echo '<div class="col-md-6" style="width:max-content;"><img src="'.$imgarr[$i].'" style="margin-top:20px;width:100px;height:50px;"/></div>';
                          }
                      ?></div>
                      </td>
                      <td><?php echo $record->no_of_adults ?></td>
                      <td><?php echo $record->no_of_childs ?></td>
